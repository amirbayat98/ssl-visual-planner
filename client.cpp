...
Client::Client(const quint16 & port, const string & net_address, const string & net_interface) :
...
Client::Client(const quint16 & port, const QHostAddress & addr, const QNetworkInterface & iface) :
    _socket(new QUdpSocket()),
    _port(port),
